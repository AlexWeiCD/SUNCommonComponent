    ...
    if (section == 0) {
        if (row == 0) { //滑动切换视图
            ...
            if (!self.navSlideSwitchVC) {
                UIViewController *slideSwitchVC = [[SUNSlideSwitchDemoViewController alloc] init];
                slideSwitchVC.view.backgroundColor = [UIColor whiteColor];
                self.navSlideSwitchVC = [[UINavigationController alloc] initWithRootViewController:slideSwitchVC];
            }
            ...
            if (!self.navCommonComponentVC) {
                ...
                UIViewController *textFieldDemoVC = [[UIViewController alloc] init];
                textFieldDemoVC.view.backgroundColor = [UIColor redColor];
